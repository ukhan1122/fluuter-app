      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            const Text('Rs.50', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
          ],
        ),
        ...
        Row(
          ...
          children: [
            ...
            Text(
              'Rs.${(totalPrice + 50).toStringAsFixed(0)}',
              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.redAccent),
            ),
          ],
        ),
        const SizedBox(height: 6),
        ...
        TextButton(
          onPressed: () => Navigator.pop(context),
          child: const Text('Continue Shopping', style: TextStyle(fontSize: 14, color: Colors.black87)),
        ),
      ],
    ),
  );
